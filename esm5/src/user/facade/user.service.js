...
var UserService = /** @class */ (function () {
    ...
    function () {
        var _this = this;
        return this.store.pipe(select(fromStore.getDetails)).pipe(tap((/**
         * @param {?} details
         * @return {?}
         */
        function (details) {
