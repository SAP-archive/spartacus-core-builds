...
export declare type MultiCartActions = RemoveTempCart | SetTempCart | ResetMultiCartDetails | RemoveCart | CartProcessesIncrement | CartProcessesDecrement | SetActiveCartId | ClearMultiCartState;
