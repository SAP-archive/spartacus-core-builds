...
var UpdateEmailEffects = /** @class */ (function () {
    function UpdateEmailEffects(actions$, userAccountConnector) {
        ...
        function (payload) {
             ...
             * @return {?}
             */
            function () { return new UpdateEmailSuccessAction(payload.newUid); })), catchError((/**
             * @param {?} error
             * @return {?}
             */
            function (error) {
...
var UserDetailsEffects = /** @class */ (function () {
    function UserDetailsEffects(actions$, userConnector) {
        ...
        function (payload) {
             ...
             * @return {?}
             */
            function (_) { return new UpdateUserDetailsSuccess(payload.userDetails); })), catchError((/**
             * @param {?} error
             * @return {?}
             */
            function (error) {
...
var UserOrdersEffect = /** @class */ (function () {
    function UserOrdersEffect(actions$, orderConnector) {
        ...
        this.resetUserOrders$ = this.actions$.pipe(ofType(CLEAR_USER_MISCS_DATA, CLEAR_USER_ORDERS), map((/**
         * @return {?}
         */
        function () {
