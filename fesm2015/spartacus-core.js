...
/** @type {?} */
const getUserTokenState = createSelector(getAuthState, (ɵ1$1));
/** @type {?} */
...
/** @type {?} */
const getPageContext = createSelector(getRouterState, (ɵ1$2));
const ɵ2 = /**
 * @param {?} routingState
 * @return {?}
 */
...
/** @type {?} */
const getBaseSiteData = createSelector(getSiteContextState, (ɵ1$3));
