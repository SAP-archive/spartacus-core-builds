...
class CartEntryEffects {
    ...
    constructor(actions$, cartEntryConnector) {
         ...
         * @return {?}
         */
        (entry) => new AddEntrySuccess(Object.assign({}, entry, { userId: payload.userId, cartId: payload.cartId })))), catchError((/**
         * @param {?} error
         * @return {?}
         */
