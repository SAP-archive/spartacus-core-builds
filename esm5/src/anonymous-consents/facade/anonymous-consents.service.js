...
var AnonymousConsentsService = /** @class */ (function () {
    ...
    function (templateId) {
         ...
         * @return {?}
         */
        function (authenticated) { return !authenticated; })), switchMap((/**
         * @param {?} _
         * @return {?}
         */
