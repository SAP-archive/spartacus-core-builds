...
/** @type {?} */
var reducerToken$6 = new InjectionToken('UserReducers');
/** @type {?} */
    ...
    UserStoreModule.decorators = [
        { type: NgModule, args: [{
                    imports: [
                        ...
                        ReactiveFormsModule,
                        StateModule,
                        StoreModule.forFeature(USER_FEATURE, reducerToken$6, { metaReducers: metaReducers$3 }),
