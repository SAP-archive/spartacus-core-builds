...
export declare class LoadCmsPageData extends EntityLoadAction {
    payload: PageContext;
    readonly type = "[Cms] Load Page Data";
    constructor(payload: PageContext);
}
export declare class LoadCmsPageDataFail extends EntityFailAction {
    readonly type = "[Cms] Load Page Data Fail";
    constructor(pageContext: PageContext, error: any);
}
export declare class LoadCmsPageDataSuccess extends EntitySuccessAction {
    readonly type = "[Cms] Load Page Data Success";
    constructor(pageContext: PageContext, payload: Page);
}
export declare class CmsSetPageFailIndex extends EntityFailAction {
    payload: string;
