...
export declare const getPageStateIndexEntityLoaderState: (pageContext: PageContext) => MemoizedSelector<StateWithCms, EntityLoaderState<string>, import("@ngrx/store").DefaultProjectorFn<EntityLoaderState<string>>>;
