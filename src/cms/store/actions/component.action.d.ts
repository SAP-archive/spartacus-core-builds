...
export declare class LoadCmsComponent extends EntityLoadAction {
    payload: string;
    readonly type = "[Cms] Load Component";
    constructor(payload: string);
}
export declare class LoadCmsComponentFail extends EntityFailAction {
    payload: any;
    readonly type = "[Cms] Load Component Fail";
    constructor(uid: string, payload: any);
}
export declare class LoadCmsComponentSuccess<T extends CmsComponent> extends EntitySuccessAction {
    payload: T;
    readonly type = "[Cms] Load Component Success";
    constructor(payload: T, uid?: string);
}
export declare class CmsGetComponentFromPage<T extends CmsComponent> extends EntitySuccessAction {
    payload: T[];
