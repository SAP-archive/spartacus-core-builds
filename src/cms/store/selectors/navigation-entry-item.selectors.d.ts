...
export declare const getNavigationEntryItems: (nodeId: string) => MemoizedSelector<StateWithCms, NodeItem, import("@ngrx/store/src/selector").DefaultProjectorFn<NodeItem>>;
